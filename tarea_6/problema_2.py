...
def metod_newton(fun,grad,hess,x_0,inter,tole,alpha,c_1,rho,inter_b,gu_mem=True):
    x=x_0
    m=0
    res=0
    v_x=[]
    ...
    for i in range(inter):
        ...
        if norm_g<=tole:
            ...
            try:
                ...
                p=np.copy(scipy.linalg.cho_solve((L_u,L_d),-g))
            except:
                p=-np.copy(g)
                m+=1
...
if __name__ == "__main__":
    ...
    tm_0=tm.time()
    x_beale,g_beale,i_beale,m_beale,res_beale,f_beale,v_x_beale,v_g_beale,v_f_beale=metod_newton(pro_1.fun_beale,pro_1.grad_fun_beale,pro_1.Hess_fun_beale,np.copy(x_beale_0),10000,None,1.0,0.1,0.6,100)
    tm_1=tm.time()
    ...
    plt.xlabel(r"$x_1$")
    plt.ylabel(r"$x_2$")
    plt.title("Gráfica de Beale")
    plt.legend()
    plt.savefig("Gra_1_ta_8_pr_2.pdf")
    ...
    plt.title(r"Gráfica $\|\nabla f(x_k)\|$ de Beale")
    plt.legend()
    plt.savefig("Gra_2_ta_8_pr_2.pdf")
    ...
    ax.set_ylabel(r'$x_1$')
    ax.set_zlabel(r'f')
    ax.set_title('Gráfica de Beale')
    plt.savefig("Gra_3_ta_8_pr_2.pdf")

    print("resultado himmelbau")
    ...
    tm_0=tm.time()
    x_himme,g_himme,i_himme,m_himme,res_himme,f_himme,v_x_himme,v_g_himme,v_f_himme=metod_newton(pro_1.fun_Himmelbau,pro_1.grad_fun_Himmelbau,pro_1.Hess_fun_Himmelbau,np.copy(x_himme_0),10000,None,1.0,0.1,0.6,100)
    tm_1=tm.time()
    print("time:",tm_1-tm_0)
    ...
    plt.xlabel(r"$x_1$")
    plt.ylabel(r"$x_2$")
    plt.title("Gráfica de Himmelbau")
    plt.legend()
    plt.savefig("Gra_4_ta_8_pr_2.pdf")

    plt.figure()
    plt.scatter(np.arange(len(v_g_himme)),np.linalg.norm(v_g_himme,axis=1),label="error")
    plt.xlabel("iteracciones")
    plt.ylabel(r"$\|\nabla f(x_k)\|$")
    plt.title(r"Gráfica $\|\nabla f(x_k)\|$ de Himmelbau")
    plt.legend()
    plt.savefig("Gra_5_ta_8_pr_2.pdf")
    ...
    plt.savefig("Gra_6_ta_8_pr_2.pdf")


    print("resultado Rosenbrock 2D")
    ...
    tm_0=tm.time()
    x_Rose,g_Rose,i_Rose,m_Rose,res_Rose,f_Rose,v_x_Rose,v_g_Rose,v_f_Rose=metod_newton(pro_1.fun_Rosenbrock,pro_1.gra_fun_Rosenbrock,pro_1.Hess_fun_Rosenbrock,np.copy(x_Rose_0),10000,None,1.0,0.1,0.6,100)
    tm_1=tm.time()
    print("time:",tm_1-tm_0)
    ...
    plt.xlabel(r"$x_1$")
    plt.ylabel(r"$x_2$")
    plt.title("Gráfica de Rosenbrock 2D")
    plt.legend()
    plt.savefig("Gra_7_ta_8_pr_2.pdf")

    plt.figure()
    plt.scatter(np.arange(len(v_g_Rose)),np.linalg.norm(v_g_Rose,axis=1),label="error")
    plt.xlabel("iteracciones")
    plt.ylabel(r"$\|\nabla f(x_k)\|$")
    plt.title(r"Gráfica $\|\nabla f(x_k)\|$ de Rosenbrock 2D")
    plt.legend()
    plt.savefig("Gra_8_ta_8_pr_2.pdf")
    ...
    ax.set_ylabel(r'$x_1$')
    ax.set_zlabel(r'f')
    ax.set_title('Gráfica de Rosenbrock 2D')
    plt.savefig("Gra_9_ta_8_pr_2.pdf")


    print("resultado Rosenbrock 200D")
    x_Rosen_0_1=np.ones(200)
    x_Rosen_0_1[0]=-1.2
    x_Rosen_0_1[-2]=-1.2
    tm_0=tm.time()
    x_Rose,g_Rose,i_Rose,m_Rose,res_Rose,f_Rose,v_x_Rose,v_g_Rose,v_f_Rose=metod_newton(pro_1.fun_Rosenbrock,pro_1.gra_fun_Rosenbrock,pro_1.Hess_fun_Rosenbrock,np.copy(x_Rosen_0_1),10000,None,1.0,0.1,0.6,100)
    tm_1=tm.time()
    print("time:",tm_1-tm_0)
    ...
    plt.xlabel("iteracciones")
    plt.ylabel(r"$\|\nabla f(x_k)\|$")
    plt.title(r"Gráfica $\|\nabla f(x_k)\|$ de Rosenbrock 200D")
    plt.legend()
    plt.savefig("Gra_10_ta_8_pr_2.pdf")

    print("resultado Rosenbrock 600D")
    x_Rosen_0_2=np.ones(600)
    x_Rosen_0_2[0]=-1.2
    x_Rosen_0_2[-2]=-1.2
    tm_0=tm.time()
    x_Rose,g_Rose,i_Rose,m_Rose,res_Rose,f_Rose,v_x_Rose,v_g_Rose,v_f_Rose=metod_newton(pro_1.fun_Rosenbrock,pro_1.gra_fun_Rosenbrock,pro_1.Hess_fun_Rosenbrock,np.copy(x_Rosen_0_2),10000,None,1.0,0.1,0.6,100)
    tm_1=tm.time()
    print("time:",tm_1-tm_0)
    ...
    plt.xlabel("iteracciones")
    plt.ylabel(r"$\|\nabla f(x_k)\|$")
    plt.title(r"Gráfica $\|\nabla f(x_k)\|$ de Rosenbrock 600D")
    plt.legend()
    plt.savefig("Gra_11_ta_8_pr_2.pdf")

    print("resultado hartmann")
    ...
    tm_0=tm.time()
    x_hart,ge_hart,i_hart,m_hart,res_hart,fu_hart,v_x_hart,v_g_hart,v_f_hart=metod_newton(f_hart,g_hart,h_hart,np.copy(x_hart_0),10000,None,1.0,0.1,0.6,100)
    tm_1=tm.time()
    print("time:",tm_1-tm_0)
    ...
    plt.xlabel("iteracciones")
    plt.ylabel(r"$\|\nabla f(x_k)\|$")
    plt.title(r"Gráfica $\|\nabla f(x_k)\|$ de Hartmann")
    plt.legend()
    plt.savefig("Gra_12_ta_8_pr_2.pdf")
    """
